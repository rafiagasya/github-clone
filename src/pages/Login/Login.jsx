...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#f6f8fa] flex flex-col items-center justify-center py-12">
      ...
      <h1 className="text-2xl font-semibold text-[#1f2328] mb-4">Sign in to GitHub</h1>

      {/* Form Box */}
      <div className="w-full max-w-sm bg-white border border-[#d0d7de] rounded-lg p-6 shadow-sm">
        <form onSubmit={handleLogin}>
          <div className="mb-4">
            <label className="block text-sm font-semibold text-[#1f2328] mb-1">
          ...
          <button
            type="submit"
            className="w-full bg-[#1f6feb] hover:bg-[#388bfd] text-white text-sm font-semibold py-1.5 rounded-md transition-colors"
          >
            Sign in
          </button>
        </form>
